...
.setFooter(`©️ Tüm hakları saklıdır | Yeni Nesil Gelişmiş Bot | 2020`);  
  ...
  if (!öneri) {
    ...
    var embed = new Discord.MessageEmbed()
      ...
      .setAuthor("<a:hypesquad1:765529282067431437> Yeni Bir Öneri!", client.user.avatarURL())
 
      .addField("<a:hypesquad1:765529282067431437> • Öneren Kullanıcı:", message.author.tag, true)
 
      .addField("<a:hypesquad1:765529282067431437> • Öneren Kullanıcı ID:", message.author.id,true)
 
      .addField("<a:hypesquad1:765529282067431437> • Önerisi:", öneri)
