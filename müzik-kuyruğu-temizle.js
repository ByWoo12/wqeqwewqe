...
.setColor(AloneDogru)
.setTitle("Marley | Kuyruğu Temizle")
.setDescription(`<a:hypesquad1:765529282067431437> **| Müzik Kuyruğu, ${message.author} tarafından temizlendi.**`) 
...
.setTitle("• Hata: 011 •")
.setThumbnail(`https://drummofficial.com/wp-content/uploads/2017/08/equalizer3.gif`)
.setDescription(`<a:hypesquad1:765529282067431437>  **| Müzik Kuyruğunu temizleyebilmek için bir ses kanalında olmanız gerekmektedir!**`)
.setFooter(`©️ Tüm hakları saklıdır | Yeni Nesil Gelişmiş Bot | 2020`, client.user.avatarURL());  
