...
.addField(`__Oto Cevap Ekle__`,`<a:setting:765529940737130557> \`${prefix}otocevap-ekle\` Sunucunuza Özel Komut Eklemenize Yarar.`,true)
.addField(`__Oto Cevap Liste__`,`<a:setting:765529940737130557> \`${prefix}otocevap-liste\` Sunucunuzdaki Özel Komutların Listesini Gösterir.`,true)
.addField(`__Oto Cevap Sil__`,`<a:setting:765529940737130557> \`${prefix}otocevap-sil\` unucunuzdaki Özel Komutu Siler.`,true)
